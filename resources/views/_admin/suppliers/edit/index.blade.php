...
@section('title', 'Duralux || Editar Fornecedor')
    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Editar Fornecedor</h5>
            </div>
            <ul class="breadcrumb">
                ...
                <div class="card stretch stretch-full">
                    <div class="card-body">
                        <form action="{{ route('suppliers.update', $supplier) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            @include('forms._formSuppliers.index', ['supplier' => $supplier, 'buttonText' => 'Atualizar Fornecedor'])
                        </form>
                    </div>
                </div>
            </div>
