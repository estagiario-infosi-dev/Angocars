...
@section('title', 'Duralux || Card Edit')
    ...
    <div class="page-header">
        ...
        <div class="page-header-right ms-auto">
            <div class="page-header-right-items">
                ...
                <!--<a href="javascript:void(0);" class="btn btn-light-card successAlertMessage">
            ...
            <div class="col-xl-16">
                <div class="card invoice-container">
                    <div class="card-header">
                     ...
                     <!--<div class="dropdown">
                            <a href="javascript:void(0)" class="btn btn-light-card dropdown-toggle" data-bs-toggle="dropdown" data-bs-offset="0,25">Invoice Templates</a>
                    ...
                    <div class="card-body p-0">
                        <div class="px-4 pt-4">
                            <!-- <div class="d-md-flex align-items-center justify-content-between">
                                <div class="mb-4 mb-md-0 your-card">
                                    ...
                                    <div class="fs-12 text-muted mt-2">* Upload your card</div>
                                </div> -->
                            ...
                            <div class="tab-pane fade show active" id="pamymetDebitCardTab" role="tabpanel">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="hstack justify-content-end gap-1 mt-1 input-credit-card-type">
                                        <div class="amex">
                                            <i class="fs-12 fa-cards fa-cc-amex"></i>
                                        </div>
                                        <div class="mastercard">
                                            <i class="fs-12 fa-cards fa-cc-mastercard"></i>
                                        </div>
                                        <div class="visa">
                                            <i class="fs-12 fa-cards fa-cc-visa"></i>
                                        </div>
                                        <div class="discover">
                                            <i class="fs-12 fa-cards fa-cc-discover"></i>
                                        </div>
                                        <div class="jcb">
                                            <i class="fs-12 fa-cards fa-cc-jcb"></i>
                                        </div>
                                        <div class="diners">
                                            <i class="fs-12 fa-cards fa-cc-diners-club"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                ...
                <div class="card stretch stretch-full">
                    <div class="card-body">
                        <div class="mb-4 d-flex align-items-center justify-content-between">
                            ...
                            <a href="javascript:void(0);" class="btn btn-light-card">Nevermind</a>
                        </div>
